 ...
 * PNBase64Utils Class
 */
public class PNBase64Utils {

    private static final byte[] mBase64EncMap;
    private static final byte[] mBase64DecMap;
    ...
    public static String base64Encode(byte[] aData) {
        ...
        for (srcIndex=0, destIndex=0; srcIndex < aData.length-2; srcIndex += 3) {
            ...
            encodedBuf[destIndex++] = mBase64EncMap[(aData[srcIndex+1] >>> 4) & 15 |
                        (aData[srcIndex] << 4) & 63];
            encodedBuf[destIndex++] = mBase64EncMap[(aData[srcIndex+2] >>> 6) & 3 |
                        (aData[srcIndex+1] << 2) & 63];
            encodedBuf[destIndex++] = mBase64EncMap[aData[srcIndex+2] & 63];
        }
